...
function Header() {
    ...
    <nav className="navbar container-fluid d-flex flex-row justify-content-around align-items-center border-bottom border-secondary border-opacity-10">
      ...
      <div className="d-flex flex-row justify-content-between text-secondary align-items-center" style={{width: 30 + '%'}}>
        ...
        {userContext[0] !== 'true' &&
          <a className="nav-link" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Вход/Регистрация</a>
        }
        {userContext[0] === 'true' &&
          <a className="nav-link" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">{userContext[1]}</a>
        }
